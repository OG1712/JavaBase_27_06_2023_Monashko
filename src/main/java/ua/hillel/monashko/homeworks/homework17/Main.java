...
enum DrinksMachine {
    ...
    class Drinks {
        ...
        public static final double TEA_PRICE = 1;

        public static final double LEMONADE_PRICE = 3;

        public static final double MOCHITO_PRICE = 3;

        public static final double MINERAL_WATER_PRICE = 1.6;
